...
public class DataCollectionRequestHandler {
    ...
    public static final SimpleSocketRequestHandler handler = new SimpleSocketRequestHandler("COLLECTION", "GET", (SimpleSocketRequestHandler.SimpleSocketRequestHandlerCallback) (simpleSocketRequest, dataStorage) -> {
